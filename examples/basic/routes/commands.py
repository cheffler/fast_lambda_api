...
from ..models import CakeById, CakeInOven, CakeRecipe

OPENAPI_TAG_NAME: str = "Commands"
...
@import_handler(path="examples.basic.lambdas.make_a_cake")
...
@import_handler(
    path="examples.basic.lambdas.make_a_cake",
    handler="handler_v2",
)
